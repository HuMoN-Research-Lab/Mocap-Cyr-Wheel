...
fbx_file_location = "/Users/jackieallex/Downloads/WheelForcePlate0007.fbx"
tsv_file_location = "/Users/jackieallex/Downloads/WheelForcePlate0007.tsv"
#camera info
...
with open(fbx_file_location, "r") as file:
    ...
    for title, body in re.findall(r"(#\d* Miqus Video)\".*?{(.*?)}", file.read(), re.MULTILINE | re.DOTALL):
        ...
        node = SubElement(cameras, "Camera")
        node.text = title
...
#save npy
a = np.array(list1)
np.save('/Users/jackieallex/Downloads/Mocap-Cyr-Wheel/cameras.npy', a)

#raw XML file
mydata = ET.tostring(camera, encoding="unicode")
myfile = open("/Users/jackieallex/Downloads/Mocap-Cyr-Wheel/camera_output_data_raw.xml", "w")
myfile.write(mydata)
myfile.close() 
print(mydata)
...
myfile2 = open("/Users/jackieallex/Downloads/Mocap-Cyr-Wheel/camera_output_data_pretty.xml", "w")
...
#save npy
b = np.array(list2)
np.save('/Users/jackieallex/Downloads/Mocap-Cyr-Wheel/markers.npy', b)

#raw XML file
mydata = ET.tostring(camera, encoding="unicode")
myfile = open(r"/Users/jackieallex/Downloads/Mocap-Cyr-Wheel/markers_output_data_raw.xml", "w")
myfile.write(mydata)
myfile.close() 
...
dom = xml.dom.minidom.parseString(mydata)
pretty_xml_as_string = dom.toprettyxml()
myfile2 = open(r"/Users/jackieallex/Downloads/Mocap-Cyr-Wheel/markers_output_data_pretty.xml", "w")
myfile2.write(pretty_xml_as_string)
myfile2.close()
